...
void	Form::execute(const Bureaucrat & executor) const
{
	if (executor.getGrade() > gradeToExecute)
		throw Bureaucrat::GradeTooLowException("grade is too low");
	if (!isSigned)
		throw NotSignedFormException("form is not signed");
}
...
Form::NotSignedFormException::NotSignedFormException(const std::string& msg) throw () : msg(msg) {}

Form::NotSignedFormException::~NotSignedFormException() throw() {}
